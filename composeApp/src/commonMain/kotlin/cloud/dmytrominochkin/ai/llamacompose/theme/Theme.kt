...
fun shouldGoDark(darkTheme: Boolean, userOverride: Theme): Boolean =
    (darkTheme || userOverride == Theme.THEME_DARK) && userOverride != Theme.THEME_LIGHT

@Composable
expect fun LlamaComposeTheme(
